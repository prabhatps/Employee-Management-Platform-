...
exports.postUpdateProfile = (req, res, next) => {
  ...
  User.findById(req.user.id, (err, user) => {
    ...
    user.profile.martialstatus=req.body.martialstatus || '';
    user.profile.mobile=req.body.mobile || '';
    user.profile.departemnt=req.body.departemnt || '';
    user.profile.DateofJoining=req.body.DateofJoining || '';
...
/**
 * Returns the email and id of all registered users
 */
...
/**
 * Returns the email and id of logged in user
 */
exports.postserviceme=(req,res,next)=>{
